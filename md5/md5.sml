 ...
 *
 * This code is based off the source of the GNU md5sum.c program included
 * in GNU coreutils.
 *)
structure MD5 :> MD5 =
struct
    ...
    * representing one byte of large, in little-endian (reversed).
    *)
   fun unpack large =
      #[LW.andb (large, 0wxff),
   ...
   fun transform {size, digest} vec = let
      ...
      val processed = ((round4 words o round3 words o
